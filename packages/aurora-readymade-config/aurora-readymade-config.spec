...
Name:           aurora-readymade-config
Version:        0.2.0
Release:        1%{?dist}
Summary:        aurora branding for Readymade
...
%description
Branding for Auroras Readymade config
...
%install
install -Dpm0644 ./*.gresource %{buildroot}%{_datadir}/readymade/resources/aurora.gresource
